...
export default function Conhecimento() {
    return (
        <section className="flex flex-col justify-center items-center min-h-screen text-white gap-4 p-4 md:p-8 md:gap-8">
            ...
            <div className="grid gap-4 w-full">
                ...
                {/* <div className="flex justify-center items-center">
                    <h2 className="uppercase font-black text-lg">BackAnd</h2>
                </div> */}
            </div>
        </section>
    )
